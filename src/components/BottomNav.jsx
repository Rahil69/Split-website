...
function BottomNav(props) {
  return (
    <nav className="fixed bottom-6 left-1/2 w-52 max-w-sm -translate-x-1/2 rounded-full border border-white/50 !bg-white/20 p-1.5 shadow-[0_10px_24px_rgba(24,84,63,0.08)] backdrop-blur-md">
